...
public class LibraryDBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE PaperTab(_ID INTEGER PRIMARY KEY AUTOINCREMENT,PAPERID TEXT,NAME TEXT,DESCRIPTION TEXT,CONTENT TEXT,EXAMID TEXT,EXAMNAME TEXT,SUBJECTID TEXT,SUBJECTNAME TEXT,SOURCENAME TEXT,AREANAME TEXT,TYPE INTEGER,PRICE INTEGER,TIME INTEGER,YEAR INTEGER,TOTAL INTEGER,SCORE DOUBLE,PUBLISHTIME DATETIME DEFAULT (datetime('now','localtime')))");
		...
		db.execSQL("CREATE TABLE ItemTab(_ID INTEGER PRIMARY KEY AUTOINCREMENT,ITEMID TEXT,SUBJECTID TEXT,CHAPTERID TEXT,CONTENT TEXT,MATERIAL TEXT)");
	}
