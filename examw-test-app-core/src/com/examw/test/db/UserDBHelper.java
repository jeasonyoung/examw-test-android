...
public class UserDBHelper extends SQLiteOpenHelper{
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE UserTab(_id integer primary key autoincrement,uid text,userId text,username text,password text,info text,productUserId text,lastSyncTime datetime)");
