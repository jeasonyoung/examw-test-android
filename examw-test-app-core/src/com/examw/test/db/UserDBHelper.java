...
public class UserDBHelper extends SQLiteOpenHelper{
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE ItemRecordTab(_id integer primary key autoincrement,recordId text,structureId text,itemId text,itemType integer,itemContent text,answer text,termialId text,status integer,score double,useTime integer,createTime date default(datetime('now','localtime')),lastTime date default(datetime('now','localtime')))");
