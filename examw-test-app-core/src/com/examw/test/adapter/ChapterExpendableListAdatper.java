...
public class ChapterExpendableListAdatper extends BaseExpandableListAdapter {
	...
	public View getChildView(final int groupPosition, final int childPosition,
		...
		ExpandableListView treeView = getExpandableListView();
		treeView.setAdapter(new ChapterChildExpendableListAdatper(this.context,groups.get(groupPosition).getChildren()));
		treeView.setPadding(ChapterChildExpendableListAdatper.PaddingLeft*2, 0, 0, 0);
...
//						(treeNode.childs.size()+1)*ChapterChildExpendableListAdatper.ItemHeight + 10);
...
//		return convertView;
	...
	public int getChildrenCount(int groupPosition) {
		try {
			groups.get(groupPosition).getChildren().size();
			return 1;
		} catch (Exception e) {
			return 0;
		}
